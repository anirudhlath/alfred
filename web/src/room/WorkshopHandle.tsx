 ...
 * `workshop` under a small up-chevron. `Composer` renders it under the row and
 * hides it while the keyboard is up.
 *
 * The handoff also drew a 139×5 radius-3 bar in `fg` below the word. That is
 * the iPhone home indicator, part of the device frame the mock was drawn on and
 * not part of the design — on a real phone it lands beside the real one. Gone.
 *
...
export function WorkshopHandle({ onOpen }: WorkshopHandleProps) {
  return (
    <button
      ...
      className="flex min-h-11 w-full flex-col items-center border-0 bg-transparent pt-0.5 pb-2"
    >
